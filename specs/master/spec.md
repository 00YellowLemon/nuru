...
**Created**: 2025-10-30
**Status**: Draft
**Input**: Copied from `specs/001-team-portfolio/spec.md` to serve as current FEATURE_SPEC for branch `master`.

<!-- Source content below mirrors 001-team-portfolio/spec.md -->
